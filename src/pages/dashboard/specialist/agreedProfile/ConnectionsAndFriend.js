    ...
    return (
        <div>
            ...
            {friends.map((friend, index) => (
                ...
                <Grid container spacing={3} alignItems="flex-start"  onClick={() => window.location.href = friend.link}>
                    {/* Аватар */}
                    <Grid item>
                        <Avatar sx={{width: 110, height: 130, borderRadius: 2}} variant="square" src={friend.avatar}/>
                    </Grid>
                    ...
                    <Grid item xs>
                        ...
                        <Box display="flex" marginTop="5px">
                            <Box
                                ...
                                sx={{height: 20, mr: 1}}
                            />
                            <Typography color="text.secondary" sx={{fontSize:12}}>{friend.location}</Typography>
                        </Box>
                    </Grid>
                </Grid>))
            }</Box>
