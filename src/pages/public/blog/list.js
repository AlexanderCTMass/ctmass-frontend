                ...
                <Container maxWidth="xl">
                    ...
                    >
                        <Stack spacing={2}>
                            ...
                            {/* Filters (hidden on mobile when toggled off) */}
                            {(!isMobile || showFilters) && (
                                <Stack
                                    direction={{ xs: 'column', sm: 'row' }}
                                    spacing={2}
                                >
                                    <FormControl size="small"variant={"filled"}  sx={{ minWidth: 180, flex: 1 }}>
                                    ...
                                    <FormControl size="small" variant={"filled"} sx={{ minWidth: 200, flex: 1 }}>
                    ...
                    >
                        <Typography variant="body2" color="text.secondary">
                            Showing {stats.filtered} of {stats.total} articles
                        </Typography>
