...
const useUserSpecialties = (userId) => {
    ...
    useEffect(() => {
        ...
        const fetchData = async () => {
            const response = await profileApi.getUserSpecialtiesById(userId);
            const specialtiesList = response.map(uS => specialties.byId[uS.specialty])
        ...
        <Stack
            ...
            >
                <Button
                    ...
                    variant="contained"
                    disabled={!specialties && !isFetchingUserSpecialties}
                >
                    Continue
                </Button>
                <Button
