...
export const TaskModal = (props) => {
  ...
  const handleMove = useCallback(async (columnId) => {
    try {
  ...
  const handleNameUpdate = useCallback(async (name) => {
    try {
  ...
  const handleDescriptionUpdate = useMemo(() => debounce(async (description) => {
    try {
      await dispatch(thunks.updateTask({
        taskId: task.id,
        update: {
  ...
  const handleLabelsChange = useCallback(async (labels) => {
    try {
      await dispatch(thunks.updateTask({
        taskId: task.id,
        update: {
  ...
  const handleChecklistRename = useCallback(async (checklistId, name) => {
    try {
  ...
  const handleChecklistDelete = useCallback(async (checklistId) => {
    try {
  ...
  const handleCheckItemAdd = useCallback(async (checklistId, name) => {
    try {
  ...
  const handleCheckItemDelete = useCallback(async (checklistId, checkItemId) => {
    try {
  ...
  const handleCheckItemCheck = useCallback(async (checklistId, checkItemId) => {
    try {
  ...
  const handleCheckItemUncheck = useCallback(async (checklistId, checkItemId) => {
    try {
      await dispatch(thunks.updateCheckItem({
        taskId: task.id,
        checklistId,
  ...
  const handleCheckItemRename = useCallback(async (checklistId, checkItemId, name) => {
    try {
      await dispatch(thunks.updateCheckItem({
        taskId: task.id,
        checklistId,
  ...
  const handleCommentAdd = useCallback(async (message) => {
    try {
            ...
            <Stack spacing={2}>
              {task.checklists.map((checklist) => (
                <TaskChecklist
                  ...
                  onCheckItemDelete={(checkItemId) => handleCheckItemDelete(checklist.id,
                    checkItemId)}
                  onCheckItemCheck={(checkItemId) => handleCheckItemCheck(checklist.id,
                    checkItemId)}
                  onCheckItemUncheck={(checkItemId) => handleCheckItemUncheck(checklist.id,
                    checkItemId)}
                  onCheckItemRename={(checkItemId, name) => handleCheckItemRename(checklist.id,
                    checkItemId,
                    name)}
