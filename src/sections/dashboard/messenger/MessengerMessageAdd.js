...
export const MessengerMessageAdd = (props) => {
    const { disabled, templatesEnabled = false, onSend, isSending = false, inputRef, ...other } = props;
...
MessengerMessageAdd.propTypes = {
    disabled: PropTypes.bool,
    onSend: PropTypes.func,
    isSending: PropTypes.bool,
};

MessengerMessageAdd.defaultProps = {
    disabled: false,
    isSending: false,
};